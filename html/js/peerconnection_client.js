...
function PeerConnectionClient(remoteVideo, localVideo, doSendPeerMessage) {
    ...
    navigator.mediaDevices
	    ...
	    this.localVideo_.srcObject = stream;
		...
		.forEach(track => this.peerConnection_.addTrack(track, localStream));
	})

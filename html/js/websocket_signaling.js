...
function WebSocketSignalingChannel(remoteVideo, localVideo, wsPath) {
    this.remoteVideo_ = remoteVideo;
    this.localVideo_ = localVideo;
    this.wsPath_ = wsPath;

    this.doSignalingConnect();
...
WebSocketSignalingChannel.prototype.connectWebSocket = function () {
    var websocket_url;
    var websocket_url_path = this.wsPath_ || "/car/webrtc";
...
WebSocketSignalingChannel.prototype.doSignalingConnect = function () {
    ...
    if( window.WebSocket ){
        this.peerConnectionClient_ = 
            new PeerConnectionClient(this.remoteVideo_, this.localVideo_, this.doSignalingSend.bind(this) );
